...
</html>" > ~/TrackUrl/index.html

# Подождём, чтобы файл точно создался
sleep 1

# Перемещаем созданный файл и копируем изображение
sudo mv ~/TrackUrl/index.html /var/www/html/index.html
sudo cp ~/TrackUrl/skull.jpg /var/www/html/skull.jpg
